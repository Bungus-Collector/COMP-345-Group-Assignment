...
void testPlayerStrategies()
{
    ...
    t1->addAdjacentTerritory(d4);
    d4->addAdjacentTerritory(t1);
    t2->addAdjacentTerritory(d5);
    d5->addAdjacentTerritory(t2);
    t3->addAdjacentTerritory(d6);
    d6->addAdjacentTerritory(t3);

    t3->addAdjacentTerritory(d1);
    d1->addAdjacentTerritory(t3);
    t2->addAdjacentTerritory(d2);
    d2->addAdjacentTerritory(t2);
    b1->addAdjacentTerritory(d9);
    d9->addAdjacentTerritory(b1);
    b3->addAdjacentTerritory(d7);
    d7->addAdjacentTerritory(b3);
